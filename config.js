...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:3581f47eda3a548b349ebf2c5829736d";
const SUDO = process.env.SUDO || '94783337i16';
...
const BOT_INFO = process.env.BOT_INFO || "*LAKY ✴*;MALITH LAKSHAN;https://telegra.ph/file/fb6d0176c031132f531e1.jpg";
const URL = process.env.URL || "https://wa.me//+94783337816";
const AUDIO_DATA = process.env.AUDIO_DATA || "LAKY ✴;MALITH LAKSHAN;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "ᴍᴀʟɪᴛʜ ʟᴀᴋꜱʜᴀɴ;✓";
